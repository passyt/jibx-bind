...
public class JiBX_messageFactory extends BindingFactoryBase implements IBindingFactory {
	...
	private JiBX_messageFactory() {
		super(
				...
				0,
				getClassList(),
				"org.jibx.binding.test7.Mapping|....Item|....TestMapping",
				"|org.jibx.binding.test7.JiBX_messageItem_access|org.jibx.binding.test7.JiBX_messageTestMapping_access",
				"|org.jibx.binding.test7.JiBX_messageItem_access|org.jibx.binding.test7.JiBX_messageTestMapping_access",
				...
				"\001\005\007",
				null,
				"org.jibx.binding.test7.Mapping|....|....Mapping.JiBX_message_newinstance_1_0|||.....JiBX_message_attrTest_1_0|.....JiBX_message_unmarshalAttr_1_0|.....JiBX_message_marshalAttr_1_0|||",
	...
	private static String getClassList() {
		return "org.jibx.binding.test7.Item|....JiBX_messageFactory|....JiBX_messageItem_access|....JiBX_messageTestMapping_access|....Mapping|....TestMapping";
	}
