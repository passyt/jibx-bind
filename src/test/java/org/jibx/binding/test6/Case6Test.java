...
public class Case6Test {
	...
	protected void autoBind() throws Exception {
		String outputPath = Case6Test.class.getClassLoader().getResource("").getPath();
		String bindingFile = Case6Test.class.getResource("binding.xml").getPath();
	...
	protected void executeTest() throws Exception {
		...
		Assert.assertEquals(IOUtils.toString(Case6Test.class.getResourceAsStream("output.xml")), writer.toString());
