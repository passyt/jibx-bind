...
public class Case4Test {
	...
	public void executeTest() throws Exception {
		...
		Assert.assertEquals(IOUtils.toString(Case4Test.class.getResourceAsStream("output.xml")), writer.toString());
	...
	protected void autoBind() throws Exception {
		String outputPath = Case4Test.class.getClassLoader().getResource("").getPath();
		String bindingFile = Case4Test.class.getResource("binding.xml").getPath();
