package org.jibx.binding.test5;
...
public class JiBX_messageFactory extends BindingFactoryBase implements IBindingFactory {
	...
	private JiBX_messageFactory() {
		super(
				...
				0,
				getClassList(),
				"org.jibx.binding.test5.Mapping|....TestMapping",
				"|org.jibx.binding.test5.JiBX_messageTestMapping_access",
				"|org.jibx.binding.test5.JiBX_messageTestMapping_access",
				...
				"\001\007",
				null,
				"org.jibx.binding.test5.Mapping|....|....Mapping.JiBX_message_newinstance_1_0|||.....JiBX_message_attrTest_1_0|.....JiBX_message_unmarshalAttr_1_0|.....JiBX_message_marshalAttr_1_0|||",
	...
	private static String getClassList() {
		return "org.jibx.binding.test5.JiBX_messageFactory|....JiBX_messageTestMapping_access|....Mapping|....TestMapping";
	}
