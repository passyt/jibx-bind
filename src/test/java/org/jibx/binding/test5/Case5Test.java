...
public class Case5Test {
	...
	protected void executeTest() throws Exception {
		...
		Assert.assertEquals(IOUtils.toString(Case5Test.class.getResourceAsStream("output.xml")), writer.toString());
	...
	protected void autoBind() throws Exception {
		String outputPath = Case5Test.class.getClassLoader().getResource("").getPath();
		String bindingFile = Case5Test.class.getResource("binding.xml").getPath();
