...
import static org.jibx.binding.util.JibxUtils.checkNotNull;
 ...
 * "http://code.google.com/p/guava-libraries/wiki/StringsExplained#Joiner">
 * {@code Joiner}</a>.
 *
...
public class Joiner {
	 ...
	 *
	 * @since 11.0
	 * @deprecated use {@link #appendTo(Appendable, Iterator)} by casting
	 *             {@code parts} to {@code Iterator<?>}, or better yet, by
	 *             implementing only {@code Iterator} and not {@code Iterable}.
	 *             <b>This method is scheduled for deletion in June 2013.</b>
	 */
	@Deprecated
	public final <A extends Appendable, I extends Object & Iterable<?> & Iterator<?>> A appendTo(A appendable, I parts) throws IOException {
	 ...
	 *
	 * @since 11.0
	 * @deprecated use {@link #appendTo(StringBuilder, Iterator)} by casting
	 *             {@code parts} to {@code Iterator<?>}, or better yet, by
	 *             implementing only {@code Iterator} and not {@code Iterable}.
	 *             <b>This method is scheduled for deletion in June 2013.</b>
	 */
	@Deprecated
	public final <I extends Object & Iterable<?> & Iterator<?>> StringBuilder appendTo(StringBuilder builder, I parts) {
	 ...
	 *             {@code Iterator<?>}, or better yet, by implementing only
	 *             {@code Iterator} and not {@code Iterable}. <b>This method is
	 *             scheduled for deletion in June 2013.</b>
	 */
	@Deprecated
	 ...
	 * operate on {@code Multimap} entries in two distinct modes:
	 *
	 * <ul>
	 ...
	 * output of the form {@code key1=[A, B]&key2=C}.
	 * </ul>
	 *
	 * @since 2.0 (imported from Google Collections Library)
	 */
	public final static class MapJoiner {
		 ...
		 * @deprecated use {@link #appendTo(Appendable, Iterator)} by casting
		 *             {@code entries} to
		 *             {@code Iterator<? extends Entry<?, ?>>}, or better yet,
		 *             by implementing only {@code Iterator} and not
		 *             {@code Iterable}. <b>This method is scheduled for
		 *             deletion in June 2013.</b>
		 */
		@Deprecated
		public <A extends Appendable, I extends Object & Iterable<? extends Entry<?, ?>> & Iterator<? extends Entry<?, ?>>> A appendTo(A appendable, I entries) throws IOException {
		 ...
		 */
		@Deprecated
		public <I extends Object & Iterable<? extends Entry<?, ?>> & Iterator<? extends Entry<?, ?>>> StringBuilder appendTo(StringBuilder builder, I entries) throws IOException {
			Iterator<? extends Entry<?, ?>> iterator = entries;
		 ...
		 * Appends the string representation of each entry in {@code entries},
		 * using the previously configured separator and key-value separator, to
		 * {@code builder}. Identical to {@link #appendTo(Appendable, Iterable)}
		 * , except that it does not throw {@link IOException}.
		 *
		 * @since 10.0
		 */
		 ...
		 */
		@Deprecated
		public <I extends Object & Iterable<? extends Entry<?, ?>> & Iterator<? extends Entry<?, ?>>> String join(I entries) throws IOException {
			Iterator<? extends Entry<?, ?>> iterator = entries;
